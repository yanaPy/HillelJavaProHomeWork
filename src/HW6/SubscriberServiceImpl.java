...
public class SubscriberServiceImpl implements SubscriberService {
    ...
    @Override
    public void subsInfoCityTimeCallsExceedsSpecified(double time) {
    ...
    @Override
    public void subsInfoWhoUsedLongDistanceCommunication() {
    ...
    @Override
    public void subsInfo(String firstLetterOfSurname) {
    ...
    @Override
    public void totalConsumptionInetTrafficForCity(String city) {
        int sum = 0;
        for (Subscriber sub : subs) {
    ...
    @Override
    public void numberSubsWithNegativeBalance() {
        int i = 0;
        for (Subscriber sub : subs) {
            if (sub.getBalance() < 0) {
                i++;
